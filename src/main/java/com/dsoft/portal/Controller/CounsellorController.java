...
public class CounsellorController {
    ...
    @PostMapping("/login")
    public String login(CounsellorRequest request, HttpServletRequest httpServletRequest, Model model) throws Exception {
    ...
    public String register(CounsellorRequest request, Model model) throws Exception {
